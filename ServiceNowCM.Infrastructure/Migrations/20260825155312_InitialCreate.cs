        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstanceUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceNowConnections", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ServiceNowConnections_Name",
                schema: "config",
                table: "ServiceNowConnections",
                column: "Name",
                unique: true);
        }
